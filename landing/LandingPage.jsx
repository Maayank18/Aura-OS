...
<div className="page">
      ...
      <div className="feature-card reveal">
        <div className="feature-content">
          ...
          <ul className="feature-bullets">
            <li>Web Audio API → WebSocket to Node/LLM pipeline</li>
            <li>Native Web Speech API extracts pitch & cadence to detect stress</li>
  ...
  <section className="arch" id="architecture">
    <div className="container reveal">
      ...
      <p className="subtitle">The backend architecture runs real-time LLM audio — isolated from the physics canvas.</p>
    ...
    <div className="container reveal">
      ...
      <div className="team-grid">
        ...
        <div className="team-card">
          ...
          <h4>Deepanshu</h4>
          <p className="role">Audio ML · Speech Emotion</p>
          <div className="tags">
            <span>Web Audio API</span><span>Native Speech APIs</span><span>Groq</span><span>ElevenLabs</span>
          </div>
        </div>
      </div>
    </div>
